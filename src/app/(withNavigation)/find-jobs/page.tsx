  ...
  return (
    <div className="flex flex-col justify-center items-stretch">
      <div className="bg-slate-50 flex w-full flex-col pb-12 px-5 max-md:max-w-full">
        <div className="self-center flex gap-4 mt-16 items-start max-md:max-w-full max-md:flex-wrap max-md:mt-10">
          ...
          <div className="items-stretch self-stretch flex grow basis-[0%] flex-col">
            ...
            <span className="mt-4 w-full">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 455 33" fill="none">
        ...
        <p className="text-slate-500 text-center text-md leading-6 lg:text-lg lg:leading-7 self-center mt-6">
          Find your next career at companies like HubSpot, Nike, and Dropbox
        </p>
       
        <section className="mx-auto mt-5">
          <form className="border border-slate-200 bg-white px-[2vw] py-[2vh] grid grid-cols-1 md:grid-cols-[1fr_1fr_max-content] gap-[5%]">
      ...
      {/* All Jobs Section */}
      <section className="p-3 my-2 md:mt-6 lg:mt-8 max-w-screen-xl w-full mx-auto md:p-6 lg:p-7 xl:p-8 grid gap-x-2 lg:gap-x-3 xl:gap-x-4 md:grid-cols-[1fr_5fr] max-h-[calc(100vh-6rem)] h-full">
