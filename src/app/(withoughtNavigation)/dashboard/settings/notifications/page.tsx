      ...
      <form className="self-stretch mt-6 max-md:max-w-full max-md:pr-5">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          ...
          <div className="flex flex-col items-stretch w-[58%] ml-5 max-md:w-full max-md:ml-0">
            <div className="items-start flex grow flex-col max-w-max max-md:mt-10">

              <label htmlFor="app" className="flex flex-row gap-4 mt-4">
                <input id="app" type="checkbox" className="justify-center h-[25px] w-[25px] text-slate-600 text-base accent-primary" />
              ...
              <label htmlFor="job" className="flex flex-row gap-4 mt-4">
                <input id="job" type="checkbox" className="justify-center h-[25px] w-[25px] text-slate-600 text-base accent-primary" />
                <span className="flex flex-col gap-y-1">
              ...
              <label htmlFor="rec" className="flex flex-row gap-4 mt-4">
                <input id="rec" type="checkbox" className="justify-center h-[30px] w-[30px] text-slate-600 text-base accent-primary" />
                <span className="flex flex-col gap-y-1">
              ...
              <button className="text-white text-center text-base font-bold leading-7 justify-center items-center bg-primary max-w-full mt-8 px-5 py-2.5 self-end" type="submit">
                Update Email
              </button>
            </div>
          </div>
