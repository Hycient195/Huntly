  ...
  return (
    <div className="flex flex-col gap-y-4 p-2 lg:p-3 xl:p-4 border border-slate-300">
      ...
      <ul className="flex flex-col gap-y-3">
        {
          details && details.map((detail: typeof socialLinks[0], index: number) => (
            <li key={index} className="grid grid-cols-[max-content_1fr] gap-x-1.5 lg:gap-x-2">
